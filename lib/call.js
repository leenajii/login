...
module.exports = {
    ...
    getCookiesAndPostEndpoint: function (loginCookies, endpointUrl, cookie1, cookie2, done) {
        cookies.cookies(loginCookies, cookie1, cookie2, endpointUrl, function (cookiejar) {
            callEndpoint(cookiejar, endpointUrl, true);
        });
        return done;
    },
    getCookiesAndGetEndpoint: function (loginCookies, endpointUrl, cookie1, cookie2) {
        cookies.cookies(loginCookies, cookie1, cookie2, endpointUrl, function (cookiejar) {
